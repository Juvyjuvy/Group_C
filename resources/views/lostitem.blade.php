            ...
            @foreach ($items as $item)
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary check-item-btn" data-target="#itemModal{{ $item->Post_ID }}">
                            Check Item
                        </button>
                        <!-- Delete button -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Item Name: {{ $item->identify_name }}</p>
...
@section('styles')
    <style>
        .check-item-btn {
            background-color: #5c1c1c; /* Use the color palette */
            border-color: #5c1c1c; /* Use the color palette */
            transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1);
        }

        .check-item-btn:hover {
            transform: scale(1.1);
            background-color: #330b0b; /* Darken the color on hover */
            border-color: #330b0b; /* Darken the color on hover */
        }
